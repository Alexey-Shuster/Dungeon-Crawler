...
private:
    ...
    void onCreateLobbyRequest(const events::CreateLobbyRequestEvent& event);

    void onJoinLobbyRequest(const events::JoinLobbyRequestEvent& event);

    void onLeaveLobbyRequest(const events::LeaveLobbyRequestEvent& event);

    void onPlayerReadyRequest(const events::PlayerReadyRequestEvent& event);

    void onListLobbiesRequest(const events::ListLobbiesRequestEvent& event);
...
private:
    enum class LobbyLookupError { Success, PlayerNotInLobby, StaleMapping };
